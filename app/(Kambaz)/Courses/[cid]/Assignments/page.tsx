        ...
        <div id="wd-assignments" className="container-fluid p-0">
          ...
          <div className="wd-assign-list">
            <div className="wd-assign-item">
              <Link href={`/Courses/${cid}/Assignments/A1`} className="wd-assign-title fw-semibold">
                A1 - ENV + HTML
              </Link>
            ...
            <div className="wd-assign-item">
              <Link href={`/Courses/${cid}/Assignments/A2`} className="wd-assign-title fw-semibold">
                A2 - Kambaz + Labs
              </Link>
            ...
            <div className="wd-assign-item">
              <Link href={`/Courses/${cid}/Assignments/A3`} className="wd-assign-title fw-semibold">
                A3 - React + Next.js
              </Link>
